...
const ClassfeeDetails = ({ classfee }) => {
  const { dispatch } = useClassfeesContext()

  //update................

  const [updateMode, setUpdateMode] = useState(false)
  const [updatedstudentno, setUpdatedstudentno] = useState(classfee.studentno)
  const [updatedsubject, setUpdatedsubject] = useState(classfee.subject)
  const [updatedclasstype, setUpdatedclasstype] = useState(classfee.classtype) 
