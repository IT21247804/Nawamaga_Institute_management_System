...
import module_img from '../images/module.jpeg'
import pay_img from '../images/payment.jpeg'
...
const AdminMainhome = () => {
  ...
  <div className="row mt-3">
    ...
    <div className="col">
      <div className="card" id="adminhomecard2">
        <img src={module_img} class="card-img-top" alt="..." id="feedbackimg"></img>
        <div className="card-body">
          <h5 className="card-title">ADD a lesson</h5>
          <Link to="/ModuleHome" className="btn btn-primary">Add lesson</Link>
        </div>
      </div>
    </div>
    <div className="col">
      <div className="card" id="adminhomecard3">
        <img src={pay_img} class="card-img-top" alt="..." ></img>
        <div className="card-body">
          <h5 className="card-title">Create  Notice</h5>
          <a href="/Salary" className="btn btn-primary">Salary details</a>
        </div>
      </div>
    </div>
  </div>
